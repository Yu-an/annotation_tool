...
class simpleapp_tk(tk.Tk):
	def __init__(self, master):
		...
		frameButtons = tk.Frame(self, height = 2, width = 2, bg = "#FFDB58")
		frameButtons.grid(column =1, row = 2,sticky="s",columnspan=2)
		i = 0
		label = tk.Label(frameButtons, text = "Speech Act")
		label.grid(column=1,row=2,sticky="s",columnspan=2)
		i += 1
